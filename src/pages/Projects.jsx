              ...
              >
                <div className="card overflow-hidden hover-lift h-full">
                  ...
                  <div className="relative overflow-hidden">
                      ...
                      <div className="flex space-x-4 rtl:space-x-reverse">
                        {project.url && (
                          <a
                            ...
                            className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-blue hover:scale-110 transition-transform duration-300"
                          >
                    ...
                    {/* Featured Badge */}
                    {project.featured && (
                      <div className="absolute top-4 right-4 bg-brand-blue text-white px-3 py-1 rounded-full text-sm font-medium">
                        مميز
                      </div>
                    )}
                  </div>
